...
<div class="api-data-fetcher-wrapper">
  <form id="list_form" method="post" action="<?php echo esc_url(wc_get_account_endpoint_url('api-data-fetcher')); ?>">
    ...
    <div class="form-row">
      ...
      <div><?php esc_html_e('Please list each item on a separate line. For example:', 'api-data-fetcher'); ?><br><?php esc_html_e("Item 1", 'api-data-fetcher'); ?><br><?php esc_html_e("Item 2", 'api-data-fetcher'); ?><br><?php esc_html_e("Item 3", 'api-data-fetcher'); ?></div>
  ...
  <div class="api-data-fetcher-list">
    <h2><?php esc_html_e('Your API Data', 'api-data-fetcher'); ?></h2>
    <?php
